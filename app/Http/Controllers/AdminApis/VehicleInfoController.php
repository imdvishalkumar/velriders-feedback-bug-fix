...
class VehicleInfoController extends Controller
{
    ...
    public function addUpdateVehicles(Request $request){
        ...
        $validator->sometimes(['commission_percent', 'year', 'model_id', 'color', 'license_plate', 'availability'], 'required', function ($input) {
            return $input->vehicle_step == 'vehicle_details';
        });
        $validator->sometimes(['vehicle_transmission', 'engine_cc', 'seating_capacity', 'mileage', 'fuel_type', 'fuel_capacity'], 'required', function ($input) {
