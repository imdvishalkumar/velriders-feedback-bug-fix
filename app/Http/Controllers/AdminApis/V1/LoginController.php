...
class LoginController extends Controller
{
    ...
    public function adminLogin(Request $request)
    {
        ...
        logAdminActivities("Admin Login", null, null, null, $adminUser->admin_id);
    ...
    public function resetPassword(Request $request)
    {
        ...
        if ($user != '') {
            ...
            $user->save();
            logAdminActivities("Admin Password Reset", null, null, null, $user->admin_id);
