...
class CarHostController extends Controller
{
    ...
    public function storeCarHost(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            ...
            'mobile_number' => 'numeric|digits_between:8,15|unique:car_hosts,mobile_number',
    ...
    public function getCarHostUpdate(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            'firstname' => 'required',
            'lastname' => 'required',
            'email' => 'email:rfc,dns|max:255|unique:car_hosts,email,' . $request->carHostId . ',id',
            'dob' => 'required|date|before:'.Carbon::now()->setTimezone('Asia/Kolkata')->toDateTimeString(),
            'mobile_number' => 'numeric|digits_between:8,15|unique:car_hosts,mobile_number,' . $request->carHostId . ',id',
