...
use App\Models\{
    ...
    CarHostBank, VehicleCategory, VehicleDocument, VehicleProperty, RentalBooking, VehicleFeature, FuelType, Transmission, City, TripAmountCalculationRule, VehiclePriceDetail, Customer, VehicleType, CarHostVehicleStartJourneyImage, RentalReview
};
use Carbon\Carbon;
