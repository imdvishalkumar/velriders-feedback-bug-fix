...
use App\Models\{Payment, BookingTransaction, AdminPenalty, CustomerReferralDetails, Setting, PaymentReportHistory};
...
class RentalBooking extends Model
{
    ...
    {
        return $this->hasMany(AdminPenalty::class, 'booking_id', 'booking_id');
    }
