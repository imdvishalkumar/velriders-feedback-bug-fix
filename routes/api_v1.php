...
use App\Http\Controllers\FrontAppApis\V1\{BranchController, CategoryController, CustomerController, CustomerDocumentController, HomeController, RentalBookingController, VehicleController};
// HOST APP CONTROLLERS
// use App\Http\Controllers\CarhostAppApis\V1\{CarHostController, CarHostVehicleController, CarHostVehicleDetailsController};
// ADMIN PANEL CONTROLLERS
// use App\Http\Controllers\AdminApis\V1\{LoginController, VehicleDetailsController, CarHostManagementController, AdminApiController, AdminBookingController, CustomerDataController, VehicleInfoController};
...
//     Route::get('get-booking-transaction-Details', [AdminBookingController::class, 'getBookingTransactionsDetails']);
//     Route::get('get-booking-transactions', [AdminBookingController::class, 'getBookingTransactions']);
//     Route::get('export-transactions', [AdminBookingController::class, 'exportTransactions']);

//     // REMAINING BOOKING PENALTIES
//     Route::get('remaining-booking-penalties', [AdminBookingController::class, 'remainingBookingPenalties']);
//     Route::get('get-completion-penalties', [AdminBookingController::class, 'getCompletionPenalties']);
//     Route::post('store-completion-penalties', [AdminBookingController::class, 'storeCompletionPenalties']);    

//     // CUSTOMER CANCELED REFUND
//     Route::get('get-customer-canceled-refund', [AdminBookingController::class, 'getCustomerCanceledRefund']);
//     Route::post('canceled-refund-process', [AdminBookingController::class, 'canceledRefundProcess']);

//     // BOOKING CALCULATION LIST
//     Route::get('get-booking-calculation-list', [AdminBookingController::class, 'getBookingCalculationList']);
//     Route::get('export-booking-calculation-list', [AdminBookingController::class, 'exportBookingCalculationList']); // Un-used

//     // TRIP AMOUNT CALCULATION
//     Route::get('get-trip-amount-calculation-list', [AdminBookingController::class, 'getTripAmountCalculationList']);
//     Route::post('create-update-tripamt-calc', [AdminBookingController::class, 'createOrUpdateTripAmtCalc']);

//     // REWARDS MANAGEMENT
//     Route::get('get-rewards', [AdminBookingController::class, 'getRewards']);
//     Route::post('pay-rewards', [AdminBookingController::class, 'payRewards']);
